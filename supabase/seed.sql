...
--            8 regulation_items, 1 item_regulations)
-- ============================================================
...
(1, '学び舎と不思議な魔導雑貨店', '', '', '舞台はブルライト地方がユーシズ、魔法学園『七色のマナ』。', 'TEST', 'TEST', 'TEST', '');
...
あなた達は奇跡の箱庭亭を通しその名を上げ、リットバール、ひいてはクルガタに己が信じる神の名を轟かせる為、依頼を受けていく事になる。$stage$, 'TEST', 'TEST', 'TEST', '');
...
『見聞を広めるために』
『どこか遠くに行きたかったから』
訪れる理由は様々。原生生物や現地の人々と協力して、開拓の日々を始めよう！$stage$, 'TEST', 'TEST', 'TEST', '');
